...
@Deprecated
public class STPPlanetGenerator extends PlanetGenerator {
    ...
    protected void generate(){
        ...
        Seq<Block> ores = Seq.with(Blocks.oreCopper, Blocks.oreCoal, Blocks.oreTitanium, XBlocks.oreIron, Blocks.oreLead);
