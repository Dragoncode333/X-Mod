...
public class LuminaPlanetGenerator extends PlanetGenerator {
    ...
    Block[][] arr = {
        {Blocks.stone, Blocks.sporeMoss, Blocks.stone, Blocks.sporeMoss, Blocks.stone, Blocks.sporeMoss},
        {Blocks.stone, Blocks.sporeMoss, Blocks.sporeMoss, Blocks.stone, Blocks.sporeMoss, Blocks.sporeMoss},
        {Blocks.sporeMoss, Blocks.water, Blocks.sporeMoss, Blocks.water, Blocks.sporeMoss, Blocks.water},
        {Blocks.water, Blocks.sand, Blocks.water, Blocks.sand, Blocks.sand, Blocks.sand},
        {Blocks.sand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.sand},
        {Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.darksand, Blocks.darksand}
    };
    ...
    public void generate(Tiles tiles, Sector sec, int seed) {
        ...
        oreAround(Blocks.oreThorium, Blocks.sporeWall, 2, 1f, 0f);

        pass((x, y) -> {
            //trees on Blocks.sporeMoss biome
            if (floor == Blocks.sporeMoss && block == air) {
                if (rand.chance(0.01)){
            ...
            //tokicite
            if ((floor == Blocks.sand || floor == Blocks.water) && block == air) {
        ...
        enemies.each(espawn -> {
            tiles.getn(espawn.x, espawn.y).setBlock(Blocks.sand, XTeam.bessin);
