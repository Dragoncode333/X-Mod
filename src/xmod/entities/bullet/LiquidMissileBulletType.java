...
public class LiquidMissileBulletType extends BasicBulletType{
    ...
    public float puddleRange050 = Mathf.random(tilesize * 0f, tilesize * 0.50f);
    public float puddleRange075 = Mathf.random(tilesize * 0.25f, tilesize * 0.75f);
    public float puddleRange100 = Mathf.random(tilesize * 0.50f, tilesize * 1f);
    public float puddleRange125 = Mathf.random(tilesize * 0.75f, tilesize * 1.25f);
    public float puddleRange150 = Mathf.random(tilesize * 1f, tilesize * 1.50f);
    public float puddleRange175 = Mathf.random(tilesize * 1.25f, tilesize * 1.75f);
    ...
    public LiquidMissileBulletType(@Nullable Liquid liquid, float speed, float damage, String bulletSprite){
    ...
    public LiquidMissileBulletType(Liquid liquid){
    ...
    public void despawned(Bullet b){
        ...
        puddleRange050 = Mathf.random(tilesize * 0f, tilesize * 0.50f);
        puddleRange075 = Mathf.random(tilesize * 0f, tilesize * 0.75f);
        puddleRange100 = Mathf.random(tilesize * 0f, tilesize * 1f);
        puddleRange125 = Mathf.random(tilesize * 0f, tilesize * 1.25f);
