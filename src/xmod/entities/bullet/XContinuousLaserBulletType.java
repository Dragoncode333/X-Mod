...
public class XContinuousLaserBulletType extends ContinuousBulletType {
    public float fadeTime = 16f;
    public float lightStroke = 40f;
    public int divisions = 13;
    public Color[] colors = { Color.valueOf("00f9f2"), Color.valueOf("00f9f2"), Color.valueOf("00f927"),
            Color.valueOf("00f927") };
    ...
    public XContinuousLaserBulletType(float damage) {
        this.damage = damage;
    }

    public XContinuousLaserBulletType() {
    }
    ...
    public void draw(Bullet b) {
        ...
        float fout = Mathf
                .clamp(b.time > b.lifetime - fadeTime ? 1f - (b.time - (lifetime - fadeTime)) / fadeTime : 1f);
