...
public class XBulletType extends Content implements Cloneable{
    ...
    public @Nullable XBulletType fragBullet = null;
    ...
    public @Nullable XBulletType intervalBullet;
    ...
    public Seq<XBulletType> spawnBullets = new Seq<>();
    ...
    public @Nullable XBulletType lightningType = null;
    ...
    public XBulletType(float speed, float damage){
        this.speed = speed;
        this.damage = damage;
    }
    ...
    public XBulletType copy(){
        try{
            XBulletType copy = (XBulletType)clone();
    ...
    public void init(){
        ...
        //     lightningType = !collidesAir ? XBullets.damageLightningGround : XBullets.damageLightning;
        // }
    ...
    public @Nullable Bullet create(@Nullable Entityc owner, Team team, float x, float y, float angle, float damage, float velocityScl, float lifetimeScl, Object data, @Nullable Mover mover){
        return create(owner, team, x, y, angle, damage, velocityScl, lifetimeScl, data, mover);
    }
