...
public class Planete3Generatore extends PlanetGenerator{
    ...
    float rawHeight(Vec3 position){
        ...
        return (Mathf.pow(Simplex.noise3d(seed, 7, 0.5f, 1f/5f, position.x, position.y, position.z), 2.3f) + waterOffset) / (1f + waterOffset);
    }
